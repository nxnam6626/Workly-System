...
export class AuthService {
  ...
  async setupAdmin() {
    ...
    if (existing) {
      return {
        message: 'Tài khoản Supreme Admin đã tồn tại trên Môi trường này.',
        email,
      };
    }
    ...
    return {
      message: '✅ Đã khởi tạo thành công tài khoản Supreme Admin!',
      email,
      password: 'Đã thiết lập thành 123456',
    };
  }
