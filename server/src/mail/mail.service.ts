...
export class MailService {
  ...
  constructor() {
    this.transporter = nodemailer.createTransport({
      ...
      pool: true, // Tối ưu: Dùng lại kết nối (Connection Pooling)
      maxConnections: 5, // Giới hạn 5 kết nối đồng thời để tránh lỗi 421 từ Gmail
      maxMessages: 100, // Tối đa 100 tin nhắn trên mỗi kết nối
      auth: {
