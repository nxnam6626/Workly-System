  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#fcfdfe] pt-32 pb-12 flex flex-col items-center justify-center">
        ...
        <p className="text-slate-400 font-bold tracking-tight">Ðang t?i l?ch s? xem...</p>
      </div>
    );
  }
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-slate-100">
              <div className="space-y-1">
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">Vi?c làm <span className="text-blue-500">Ðã xem</span></h1>
                <p className="text-sm text-slate-500 font-medium font-sans">L?ch s? xem vi?c làm giúp b?n d? d?nh hu?ng và tìm l?i nh?ng co h?i dã lu?t qua.</p>
              </div>
                ...
                {filteredJobs.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <h3 className="text-2xl font-black text-slate-900 leading-tight">B?n chua xem <span className="text-blue-600 italic">công vi?c nào?</span></h3>
                      <p className="text-sm text-slate-400 max-w-sm mx-auto font-medium leading-relaxed">
                        L?ch s? xem s? giúp b?n luu l?i hành trình tìm ki?m. Hãy b?t d?u khám phá các co h?i ngh? nghi?p ngay!
                      </p>
                    </div>
                    <Link
                      href="/jobs"
                    ...
                    >
                      B?t d?u tìm ki?m <ArrowRight className="w-4 h-4" />
                    </Link>
                  </motion.div>
                )}
              </AnimatePresence>
