  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#fcfdfe] pt-32 pb-12 flex flex-col items-center justify-center">
        ...
        />
        <p className="text-slate-400 font-bold tracking-tight">Ðang t?i danh sách dã luu...</p>
      </div>
    );
  }
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-slate-100">
              <div className="space-y-1">
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">Vi?c làm <span className="text-rose-500">Ðã luu</span></h1>
                <p className="text-sm text-slate-500 font-medium font-sans">Luu tr? nh?ng co h?i thú v? d? chu?n b? h? so ?ng tuy?n t?t nh?t.</p>
              </div>
                ...
                {filteredJobs.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <h3 className="text-2xl font-black text-slate-900 leading-tight">Danh sách dã luu <span className="text-rose-500 italic">dang tr?ng</span></h3>
                      <p className="text-sm text-slate-400 max-w-sm mx-auto font-medium leading-relaxed">
                        Hãy luu l?i nh?ng công vi?c b?n quan tâm d? d? dàng theo dõi và ?ng tuy?n b?t c? lúc nào!
                      </p>
                    </div>
                    <Link
                      href="/jobs"
                    ...
                    >
                      Khám phá vi?c làm ngay <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </Link>
                  </motion.div>
                )}
              </AnimatePresence>
