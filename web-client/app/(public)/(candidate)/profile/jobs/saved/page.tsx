          ...
          <aside className="lg:col-span-1 space-y-6">
             <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                ...
                <div className="p-2 space-y-1">
                   <Link href="/profile/jobs/applied" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 rounded-xl transition-colors font-medium">
                      <Briefcase className="w-4 h-4 opacity-70" />
                      Việc làm đã ứng tuyển
                   </Link>
                   <Link href="/profile/jobs/saved" className="flex items-center gap-3 px-4 py-2.5 text-sm font-bold text-blue-600 bg-blue-50/50 rounded-xl transition-colors">
                      <Bookmark className="w-4 h-4" />
                      Việc làm đã lưu
                   </Link>
                   <Link href="/profile/jobs/matching" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-slate-50 rounded-xl transition-colors font-medium">
